...
import { api } from "./api";
export const fetchUserImages = createAsyncThunk("camera/fetchUserImages", async (payload, {
  rejectWithValue
}) => {
  try {
...
export const uploadImage = createAsyncThunk("camera/uploadImage", async (payload, {
  rejectWithValue
}) => {
  try {
